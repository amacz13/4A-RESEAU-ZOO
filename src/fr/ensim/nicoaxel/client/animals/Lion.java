...
public class Lion extends Animal {
    ...
    public Lion(int x, int y, String color) {
        super(x, y, Espece.LION,1, 5,30 , color);
    }
    public Lion(int x, int y, char sex, String color) {
        super(x, y, Espece.LION, sex, 1, 5, 30, color);
    }
